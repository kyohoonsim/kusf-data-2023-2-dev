...
3. crud.py에 유저에게 제공하고자 하는 데이터를 crud하는데 필요한 함수들 추가
    ...
    if platform.system() == 'Darwin':
        db_package = 'mysqlconnector'
    else:
        db_package = 'pymysql'

    SQLALCHEMY_DATABASE_URL = f"mysql+{db_package}://{db_info['user']}:{db_info['pwd']}@{db_info['host']}:{db_info['port']}/{db_info['db']}?charset=utf8"
